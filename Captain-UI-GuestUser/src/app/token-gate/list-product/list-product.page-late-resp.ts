...
// try for Voice Input in Angular Application
...
/*
      ...
      this.recognition.onend = () => {
        ...
        this.userInput = this.final_transcript
      ...
      this.recognition.onresult = (event: any) => {
        ...
        this.userInput = this.capitalize(this.final_transcript);
        ...
        return;
        // this.searchbar.nativeElement.innerHTML = this.linebreak(this.final_transcript);
