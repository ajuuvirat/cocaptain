...
export class ListProductPage implements OnInit {
  ...
  private loadingController: LoadingController) { 
    ...
    console.log('router',this.orderId);
    ...
    toggleInstructions(product:any) {
        this.showInstructions = true;
        product.buttonLabel = 'Share food';  
  ...
  ngOnInit() {
    ...
    console.log('userDetails7896',userDetails);
...
productList.forEach(item =>{
  ...
  this.productNames = productList
    ...
    this.filteredProducts.forEach(element =>{
      element.buttonLabel = 'Share food';
    })
